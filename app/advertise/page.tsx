...
export const metadata: Metadata = { title: "Advertise — Just Awaken Spirit", description: "Advertise with Just Awaken Spirit and reach a targeted audience interested in spirituality and mindful living." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">Advertise on Just Awaken Spirit</h1>
        <p className="page-subtitle">Reach a highly engaged audience of readers actively researching and comparing spirituality and mindful living. Our visitors are decision-ready — they come here to find the best options.</p>
        ...
        <h2>Get in Touch</h2>
        <p>For pricing, media kit, and availability, contact us at <a href="mailto:hello@justawakenspirit.com">hello@justawakenspirit.com</a> with the subject line "Advertising Inquiry". We'll respond within 2 business days.</p>
      </div>
    </>
  );
}
